...
function initLight() {
	...
	nl.position.set(-1, -1, -1);
	scene.add(nl);
	var ambientLight = new THREE.AmbientLight(0x4b4b4b);
...
function initObject() {
    ...
    loader.load("lib/China_Art_Museum/models/chinazhuti.js", function(geometry) {
    ...
    loader.load("lib/China_Art_Museum/models/group3.js", function(geometry) {
    ...
    loader.load("lib/China_Art_Museum/models/group2.js", function(geometry) {
    ...
    loader.load("lib/China_Art_Museum/models/group4.js", function(geometry) {
    ...
    loader.load("lib/China_Art_Museum/models/group_diban.js", function(geometry) {
    ...
    loader.load("lib/China_Art_Museum/models/group_ladder.js", function(geometry) {
    	var material = new THREE.MeshLambertMaterial({color : 0x808080});
    	var mesh = new THREE.Mesh(geometry, material);
    	//mesh.castShadow = true;
    	mesh.receiveShadow = true;
